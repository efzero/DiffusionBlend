...
from solver_3d_baselines import Diffusion as Diffusion_baseline
from solver_3D_blend import Diffusion as Diffusion_blend
from solver_3d_blend_timetravel import Diffusion as Diffusion_blendtt
from eval_3DCT_blendcond import Diffusion as Diffusion_blendcond
from eval_3D_blend_cond_lidc import Diffusion as Diffusion_blendcond_lidc
from solver_3D_diffusionmbir import Diffusion as Diffusionmbir
...
def main():
    ...
    try:
        ...
        elif args.type == "3dblend":
            runner = Diffusion_blend(args, config)
        elif args.type == "3dblendtt":
            runner = Diffusion_blendtt(args, config)
        elif args.type == "3dblendcond":
            runner = Diffusion_blendcond(args, config)
        elif args.type == "3dblendcond_lidc":
            runner = Diffusion_blendcond_lidc(args, config)
        elif args.type == "3dbaseline":
            runner = Diffusion_baseline(args, config)
        elif args.type == "diffusionmbir":
            runner = Diffusionmbir(args, config)
